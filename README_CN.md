...
1. **下载预编译版本**：
   - [Windows x64](https://github.com/kiss-kedaya/openclaw-observational-memory/releases/latest/download/observational-memory-windows-x64.exe)
   - [macOS x64](https://github.com/kiss-kedaya/openclaw-observational-memory/releases/latest/download/observational-memory-macos-x64)
   - [macOS ARM64](https://github.com/kiss-kedaya/openclaw-observational-memory/releases/latest/download/observational-memory-macos-arm64)
   - [Linux x64](https://github.com/kiss-kedaya/openclaw-observational-memory/releases/latest/download/observational-memory-linux-x64)
